...
DROP TRIGGER IF EXISTS set_update_time_dinky_user_tenant ON public.dinky_user_tenant_backup;
    ...
    BEGIN
        ...
        WHILE i <= array_length(table_seq_info, 1) LOOP
                ...
                BEGIN
                    ...
                    EXECUTE format('CREATE SEQUENCE %I START WITH %s INCREMENT BY 1 ',
                                   seq_name,
