DROP TRIGGER IF EXISTS set_update_time_dinky_user ON public.dinky_user;
...
DROP trigger IF EXISTS update_dinky_dinky_resources ON public.dinky_resources_backup;
...
DROP trigger IF EXISTS set_update_time_dinky_alert_instance ON public.dinky_alert_instance_backup;
...
-- ----------------------------
SELECT public.drop_index_if_exists('public', 'alert_group_un_idx', 'dinky_alert_group');
...
DROP trigger IF EXISTS set_update_time_dinky_alert_group ON public.dinky_alert_group_backup;
...
-- ----------------------------
SELECT public.drop_index_if_exists('public', 'dinky_alert_template_unx_idx', 'dinky_alert_template');
...
-- public.dinky_git_project
DROP trigger IF EXISTS update_dinky_alert_template ON public.dinky_alert_template_backup;
...
-- public.dinky_git_project
DROP trigger IF EXISTS update_dinky_alert_rules ON public.dinky_alert_rules_backup;
...
DROP trigger IF EXISTS update_dinky_fragment_modtime ON public.dinky_fragment_backup;
